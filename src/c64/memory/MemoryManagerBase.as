...
package c64.memory
{
	...
	public class MemoryManagerBase implements IMemoryManager, IEventDispatcher
	{
		...
		public function MemoryManagerBase() {
			init();
		}
		...
		*/
		public function read(address:uint):int {
			...
			return MemoryBankInfo(memoryBankInfo[f]).image[address];
		}
