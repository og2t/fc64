...
package net.hires.debug
{
	...
	{	
		...
		protected var line:Sprite = new Sprite();
		 ...
		 */
		public function Stats(visibility:Boolean = false, _theme : Object = null ) : void
		{
			visible = visibility;
		...
		private function init(e : Event) : void
		{
			...
			if (stage) stage.addEventListener(KeyboardEvent.KEY_DOWN, keyDown, false, 0, true);
		}
...
//				line.graphics.lineTo(graph.width - 1, graph.height - fps_graph);
				graph.bitmapData.scroll( -1, 0 );
				graph.bitmapData.fillRect( rectangle , theme.bg );
				/*stage.quality = StageQuality.LOW;
				graph.bitmapData.draw(line);
				...
				/*line.graphics.clear();
				line.graphics.lineStyle(2, theme.fps, 1);
				line.graphics.moveTo(graph.width - 1 + 10, graph.height - fps_graph);*/
